...
resource "aws_iam_role_policy_attachments_exclusive" "this" {
  ...
  policy_arns = [for _, policy in try(aws_iam_role_policy_attachment.this, {}) : policy.policy_arn]
}
...
resource "aws_iam_role_policies_exclusive" "this" {
  ...
  role_name    = aws_iam_role.this.id
  policy_names = [for _, policy in try(aws_iam_role_policy.this, {}) : policy.name]
}
